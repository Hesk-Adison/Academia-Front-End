...
@Component({
  selector: 'app-modalrelatorio',
  templateUrl: './modalrelatorio.component.html',
  styleUrls: ['./modalrelatorio.component.scss'],
  standalone: true,
...
pageIndex: number = 0;
  ...
  ngOnInit(): void {
    ...
    console.log('estou nos relatórios')     
  }
    ...
    Swal.fire({
      ...
      if (resultado.isConfirmed) {
        ...
        this._rltvService.eliminar(rltv.rltstamp).subscribe({
          next: (data) => {
            if (data.sucesso) {
              this._loginService1.mostrarAlerta("rltv eliminado com sucesso", "Ok");
              this.getrltv();
            } else {
              this._loginService1.mostrarAlerta("Nao foi possível eliminar o rltv", "Erro");
            }
          },
          error: (e) => {
...
//   this.loginService.GetRelatorio().subscribe((data)=>{
//     this.rltview = data.dados.rltview
...
//   // this.dialog.id = "projects-modal-component";
//   //   this.dialog.height = "500px";
