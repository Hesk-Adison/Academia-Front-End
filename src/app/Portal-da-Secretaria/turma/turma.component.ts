...
import { turma } from '../Turmas/todastabelasturma';
// import { ModalturmaComponent } from '../modalturma/modalturma.component';
import { ModalturmaComponent } from '../Turmas/Componentes/modalturma/modalturma.component';
  ...
  eliminarestudante(estudante: turma) {
    ...
    Swal.fire({
      ...
      if (resultado.isConfirmed) {
        ...
        this._ElinarServic.eliminargradelsddgd(estudante.turmastamp,tab,`turmastamp`).subscribe({
          next: (data) => {
            if (data.sucesso) {
