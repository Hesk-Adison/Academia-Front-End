...
import { ModalMatriculaComponent } from '../../MatriculaAluno/modal-matricula/modal-matricula.component';
import { matriculaAluno } from '../../MatriculaAluno/todasClassesmatricula';
import { ModalInscricoesComponent } from '../../modalInscricoes/modal-inscricoes/modal-inscricoes.component';
...
dataaa: { dadosmatricula: dadosmatricula } = {
  ...
  initialLoad(valor: string) {
    ...
    this.dataaa.dadosmatricula.tipo=this.inscricao
...
let plano:matriculaAluno={
  ...
  nomedoc: ''
    ...
    this.dialog.open(ModalInscricoesComponent, {
      // height: '85%',
      width: '100%',
      disableClose: true,
      data: plano,
