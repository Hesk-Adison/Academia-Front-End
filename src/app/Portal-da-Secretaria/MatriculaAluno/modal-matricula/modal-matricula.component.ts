...
import { tdocMat, matriculaAluno, matriculaTurmaAlunol, planopag, disciplinaTumra } from '../todasClassesmatricula';
import { horario, turma, turmadisc, turmal, turmanota } from '../../Turmas/todastabelasturma';
import { SelectionModel } from '@angular/cdk/collections';
import { Modalproc2Component } from '../../modalproc2/modalproc2.component';
import { ModalprocdisciComponent } from './modalprocdisci/modalprocdisci.component';
...
export interface PeriodicElementbcbcbc {
  name: string;
  position: number;
  weight: number;
  symbol: string;
...
const ELEMENT_DATA: PeriodicElementbcbcbc[] = [
    ...
    disabled = false;   
      constructor(
        ...
        private _loginservice: LoginServiceService,
         private modalActual: MatDialogRef<ModalMatriculaComponent>,
        ...
        if(this.dadosestudantes.descricao!=''){        
          ...
          this.titloAccao=`Actualizar matrícula`;
          this.botaoAccao=`Salvar`;
        }
