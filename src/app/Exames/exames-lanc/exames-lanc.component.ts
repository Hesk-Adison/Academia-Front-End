...
@Component({
  selector: 'app-exames-lanc',
  templateUrl: './exames-lanc.component.html',
  styleUrls: ['./exames-lanc.component.scss']
})
export class ExamesLancComponent {
...
carregarMancdoc(mancdoc: Turmanota1[]) {  
  ...
  let formGroup: FormGroup = new FormGroup(
    {
      ...
      e1:new FormControl({value: item.e1, disabled: this.Habilita1}),
      e2:new FormControl({value: item.e2, disabled: this.Habilita2}),
      es:new FormControl({value: item.es, disabled: this.Habilita3}),
      ...
      n1:new FormControl(item.n1),
      n2:new FormControl(item.n2),
      n3:new FormControl(item.n3),
  ...
  this.router.navigate(['Adim/Parametrosvaliacao', {id : 'exame'}])
  }
