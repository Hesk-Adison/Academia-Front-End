...
import { MY_DATA_FORMATS } from 'src/app/ModalParamRel/modal-param-rel/modal-param-rel.component';
...
//======================Teste======================
  ...
  disabled = false;   
    ...
    horariostamp:['', [Validators.required]], 
    turmastamp:['', [Validators.required]], 
