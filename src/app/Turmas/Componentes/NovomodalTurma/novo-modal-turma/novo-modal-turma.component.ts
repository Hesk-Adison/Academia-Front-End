...
import { Turmaservico } from 'src/app/Turmas/sertvico/turmaservico';
import { horario, turma, turmadisc, turmal, turmanota } from 'src/app/Turmas/todastabelasturma';
//import { ModalturmaComponent } from '../../modalturma/modalturma.component';
@Component({
  selector: 'app-novo-modal-turma',
  templateUrl: './novo-modal-turma.component.html',
  styleUrls: ['./novo-modal-turma.component.scss'],
  providers: [
...
export class NovoModalTurmaComponent implements OnInit {
